...
export function ScrollIntoProduct() {
    ...
    return (
        <div className="w-full md:w-6/12 xl:w-4/12 space-y-5 flex items-center md:items-start flex-col" aria-label="left-side">
            <h2 className="font-fredoka font-bold text-[0.85rem] md:text-xl lg:text-3xl leading-[150%] text-center md:text-left">BEST DEAL Beli sekarang ​dan dapatkan GRATIS ​update konten selamanya !</h2>
            <button
