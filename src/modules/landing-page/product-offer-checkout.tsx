    ...
    return (
        <React.Fragment>
            <div className="space-y-6 md:space-y-12 py-space_between_section_sm">
                ...
                <div className="text-center">
                    <h4 className="font-fredoka text-xs md:text-2xl xl:text-[2rem] font-bold">All Guide book ini bisa kamu dapatkan dengan harga</h4>
                ...
                <div className="relative text-center z-[2]">
                    <p className="font-mulish font-semibold text-[#5D5D5D] text-xs md:text-base">Harga spesial hari ini!</p>
                    <h3 className="font-fredoka text-2xl md:text-6xl font-bold">Rp. {priceFormat(offer?.data.originalPrice ?? 0)},-</h3>
                </div>
                <button
