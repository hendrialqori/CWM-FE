...
function ProductCard(props: ProductCardProps) {
    return (
        <figure className="bg-white rounded-2xl overflow-hidden shadow-md">
            ...
            <figcaption>
                <div className="space-y-7 px-5 py-6">
                    <h3 className="font-fredoka font-bold text-xl">{props.title}</h3>
                    ...
                    <div className="flex justify-between">
                        <div className="font-mulish">
                            ...
                            <p className="font-bold text-lg">Rp {priceFormat(props.originalPrice)}</p>
                        </div>
                        <button className="flex items-center justify-between gap-x-3 px-5 py-[10px] text-white rounded-lg
...
function ProductListCard() {
    return (
        <section className="space-y-20 pt-20" aria-label="product list card">
            <h4 className="font-fredoka text-2xl font-bold text-center">Atau bisa juga pilih e-book yg lebih relevan buat kamu</h4>
